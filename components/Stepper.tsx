            ...
            <div className={`${footerClassName}`}>
              <div className={`mt-6 flex ${currentStep !== 1 ? 'justify-between' : 'justify-end'}`}>
                ...
                <button
                  ...
                  className="bg-white text-black px-8 py-3 text-sm font-bold rounded-2xl active:scale-[0.98] transition-all shadow-[0_10px_40px_rgba(255,255,255,0.15)] flex items-center gap-2"
                  {...nextButtonProps}
                >
